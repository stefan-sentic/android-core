...
class GetCommentsForPost @Inject constructor(
    private val postRepository: PostRepository
) : CoreUseCase(), IParamUseCase<Int, Result<List<Comment>>> {

    override suspend fun invoke(data: Int): Result<List<Comment>> =
        postRepository.getComments(data)
}
